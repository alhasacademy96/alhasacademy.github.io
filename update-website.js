...
// Main function to update website
function updateWebsite() {
    try {
        ...
        console.log('2. Your live website will be updated automatically');
        console.log('3. RSS feeds will be available at:');
        console.log(`   - ${config.siteUrl}/rss.xml`);
        console.log(`   - ${config.siteUrl}/weeknotes-rss.xml`);
